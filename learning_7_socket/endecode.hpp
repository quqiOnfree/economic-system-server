...
/// <returns></returns>
XLIB bool EncryptFile(std::string passwd, std::string in_filename, std::string out_filename, bool is_enc);
...
/// <param name="is_enc">加密还是解密（加密true）</param>
/// <returns></returns>
XLIB bool XSecEncryptFile(std::string passwd, std::string in_filename, std::string out_filename, bool is_enc);
